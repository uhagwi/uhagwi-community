-- ============================================================================
-- 0003_comments.sql — 응원 댓글
-- ERD §2-3 기준
-- ============================================================================

-- ----------------------------------------------------------------------------
-- comments — 하네스에 달리는 응원 댓글
-- ----------------------------------------------------------------------------
-- juzzep_score: 0~100 · 응원지수 (서버 추론 또는 운영자 보정)
...
comment on table comments is '하네스 응원 댓글 · juzzep_score 0~100';
comment on column comments.juzzep_score is '응원지수 · null 허용(추론 대기 상태)';
